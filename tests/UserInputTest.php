...
class UserInputTest extends BaseTestCase
{
    public function testStrings()
    {
        ...
        $this->assertEquals($expected, UserInput::Sanitize($input, 's'));
        $this->mockWpKses($input);
        $this->assertEquals($expected, UserInput::Sanitize($input, 'str'));
        $this->mockWpKses($input);
        $this->assertEquals($expected, UserInput::Sanitize($input, 'string'));
    ...
    public function testIntegers()
    {
        ...
        $expected = '';
        $this->mockWpKses($input);
        $this->assertEquals($expected, UserInput::Sanitize($input, 'i'));
        ...
        $this->assertEquals($expected, UserInput::Sanitize($input, 'i'));
        $this->mockWpKses($input, '1');
        $this->assertEquals($expected, UserInput::Sanitize($input, 'int'));
        $this->mockWpKses($input, '1');
        $this->assertEquals($expected, UserInput::Sanitize($input, 'integer'));
    ...
    public function testFloats()
    {
        ...
        $expected = '';
        $this->mockWpKses($input);
        $this->assertEquals($expected, UserInput::Sanitize($input, 'f'));
        ...
        $this->assertEquals($expected, UserInput::Sanitize($input, 'f'));
        $this->mockWpKses($input, '1.2');
        $this->assertEquals($expected, UserInput::Sanitize($input, 'float'));
