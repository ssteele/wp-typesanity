...
class UserInputTest extends BaseTestCase
{
    ...
    public function testStrings()
    {
        ...
        $this->assertEquals($expected, $this->userInput->sanitize($input, 's'));
        $this->mockWpKses($input);
        $this->assertEquals($expected, $this->userInput->sanitize($input, 'str'));
        $this->mockWpKses($input);
        $this->assertEquals($expected, $this->userInput->sanitize($input, 'string'));
    ...
    public function testIntegers()
    {
        ...
        $expected = '';
        $this->mockWpKses($input);
        $this->assertEquals($expected, $this->userInput->sanitize($input, 'i'));
        ...
        $this->assertEquals($expected, $this->userInput->sanitize($input, 'i'));
        $this->mockWpKses($input, '1');
        $this->assertEquals($expected, $this->userInput->sanitize($input, 'int'));
        $this->mockWpKses($input, '1');
        $this->assertEquals($expected, $this->userInput->sanitize($input, 'integer'));
